...
class HomePageMarketListHorizontalNewsShimmer extends StatelessWidget {
  const HomePageMarketListHorizontalNewsShimmer({super.key});
                      ...
                      SizedBox(
                        ...
                        child: Shimmer.fromColors(
                          ...
                          child: Container(
                            height: Dimensions.space50,
                            width: Dimensions.space50,
                            decoration: BoxDecoration(color: MyColor.colorWhite, borderRadius: BorderRadius.circular(100)),
                          ),
                        ),
                      ),
                      const SizedBox(
