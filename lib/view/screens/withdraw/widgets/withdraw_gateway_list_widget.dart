...
class WithdrawGateWayBottomSheetWidget extends StatelessWidget {
  final WithdrawController controller;
  const WithdrawGateWayBottomSheetWidget({super.key, required this.controller});
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: controller.filteredWithdrawMethodList.isNotEmpty
                        ? Column(
                            children: List.generate(
                              controller.filteredWithdrawMethodList.length,
                              (index) {
                                var item = controller.filteredWithdrawMethodList[index];
                                return GestureDetector(
                                  onTap: () {
                                    controller.setWithdrawMethod(item);
                                    Get.back();
                                  },
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: controller.selectedWithdrawMethod == item ? MyColor.getPrimaryColor() : MyColor.getBorderColor(),
                                      ),
                                    ),
                                    child: Text(
                                      item.name ?? '',
                        ...
                        : Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  MyStrings.noWithdrawMethod.tr.rKv({"currency": controller.selectedWithdrawCurrency?.name ?? ''}),
