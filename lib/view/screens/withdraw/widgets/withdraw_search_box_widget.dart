...
class WithDrawSearchBoxAppBar extends StatelessWidget implements PreferredSizeWidget {
  final WithdrawController controller;
  const WithDrawSearchBoxAppBar({super.key, required this.controller});
  @override
                      ...
                      Expanded(
                        child: TextField(
                          decoration:  InputDecoration(
                            hintText: "${MyStrings.selectWithdrawCurrency.tr}...",
                            border: InputBorder.none,
                          ),
                          onChanged: (value) {
                            controller.filterWithdrawCurrencyDataList(value);
                          },
                        ),
                      ),
                    ],
