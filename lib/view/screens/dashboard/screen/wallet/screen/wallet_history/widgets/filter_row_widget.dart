    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children:  [
            widget.fromTrx ? Expanded(child: Text(widget.text.tr,style: regularDefault.copyWith(overflow: TextOverflow.ellipsis,color: widget.isFilterBtn ? MyColor.getPrimaryTextColor() : MyColor.getPrimaryTextColor()))): Expanded(child: Text(widget.text.tr,style: regularDefault.copyWith(color:MyColor.colorBlack,overflow: TextOverflow.ellipsis),)),
