...
import '../../../../data/model/order/order_list_response_model.dart';
...
class OrderListTileWidget extends StatelessWidget {
  ...
  final OrderListSingleData item;
                      ...
                      onPressed: ((controller.cancelOrderRateLoadingID == item.id))
                          ...
                          : () {
                              AppDialog().warningAlertDialog(
                                context,
                                () {
                                  controller.cancelOrderRate(orderID: item.id ?? '-1', tradeCoinSymbol: tradeCoinSymbol);
                                },
                      ...
                      children: [
                        IconButton(
                          onPressed: ((controller.updateOrderRateAmountButtonLoadingID == item.id))
                              ? null
                              : () {
                                  controller.updateOrderRate(symbolID: tradeCoinSymbol, orderID: item.id ?? '-1');
                                },
