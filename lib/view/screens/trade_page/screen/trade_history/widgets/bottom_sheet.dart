                    ...
                    return Material(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(4), color: MyColor.getScreenBgSecondaryColor()),
                          child: Text(
                            ' ${callFrom == 2 ? StringConverter.replaceUnderscoreWithSpace(list[index].capitalizeFirst ?? '') : list[index]}',
                            style: regularDefault.copyWith(fontSize: Dimensions.fontDefault, color: MyColor.getSecondaryTextColor()),
                          ),
                        ),
                      ),
                    );
