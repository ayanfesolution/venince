...
class DepositMethodSearchBoxAppBar extends StatelessWidget implements PreferredSizeWidget {
  final DepositController controller;
  const DepositMethodSearchBoxAppBar({super.key, required this.controller});
                      ...
                      Expanded(
                        child: TextField(
                          decoration: const InputDecoration(
                            hintText: "${MyStrings.selectPaymentMethod}...",
                            border: InputBorder.none,
                          ),
                          onChanged: (value) {
                            controller.filterDepositCurrencyDataList(value);
                          },
                        ),
                      ),
                    ],
